...
const Player = React.forwardRef(function Player(
  ...
  return (
    <div
      ...
      ref={ref}
    >
      <div className="bg-white border-slate-100 dark:bg-violet-400 dark:border-slate-500 border-b rounded-t-xl p-4 pb-6 sm:p-10 sm:pb-8 lg:p-6 xl:p-10 xl:pb-8 space-y-6 sm:space-y-8 lg:space-y-6 xl:space-y-8">
        <div className="flex items-center space-x-4">
          ...
          <div className="min-w-0 flex-auto space-y-1 font-semibold">
            ...
            <h2 className="text-green-500 dark:text-slate-50 text-lg leading-6 truncate">
              New at Config!
            </h2>
      ...
      <div className="bg-slate-50 text-slate-500 dark:bg-slate-600 dark:text-slate-200 rounded-b-xl flex items-center">
        ...
        <Button
          className="bg-white text-slate-900 dark:bg-slate-100 dark:text-slate-700 flex-none -my-2 mx-auto w-20 h-20 rounded-lg border-2 border-slate-900/5 shadow-md flex items-center justify-center"
          aria-label="Pause"
        >
